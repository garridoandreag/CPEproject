...
class CreateSubjectstudentTable extends Migration
{
    ...
    public function up()
    {
        DB::statement("
            ...
            CONSTRAINT fk_subjectstudent_coursegrade FOREIGN KEY (coursegrade_id) REFERENCES COURSEGRADE(id),
            CONSTRAINT fk_subjectstudent_student FOREIGN KEY (student_id) REFERENCES student(id),
            CONSTRAINT fk_subjectstudent_grade FOREIGN KEY (grade_id) REFERENCES grade(id),
            CONSTRAINT fk_subjectstudent_cycle FOREIGN KEY (cycle_id) REFERENCES cycle(id)
            )ENGINE=InnoDb;
            ");
    }
