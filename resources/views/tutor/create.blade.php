                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form id="tutorForm" method="POST"
                                action="{{ isset($tutor) ? route('tutor.update') : route('tutor.store') }}"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="names" type="text"
                                            ...
                                            value="{{ $tutor->person->names ?? '' }}" required autocomplete="names"
                                            autofocus>
                                        @error('names')
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="first_surname" type="text"
                                            ...
                                            name="first_surname" value="{{ $tutor->person->first_surname ?? '' }}"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="second_surname" type="text"
                                            ...
                                            name="second_surname" value="{{ $tutor->person->second_surname ?? '' }}"
                                ...
                                <div class="form-group row">
                                    <label for="phone_number" class="col-md-4 col-form-label text-md-right">Teléfono
                                    </label>
                                    <div class="col-md-6">
                                        <input id="phone_number" type="text"
                                            class="form-control @error('phone_number') is-invalid @enderror"
                                            name="phone_number" value="{{ $tutor->person->phone_number ?? '' }}"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="cellphone_number" type="text"
                                            ...
                                            name="cellphone_number" value="{{ $tutor->person->cellphone_number ?? '' }}"
                                            autocomplete="cellphone_number" autofocus>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="home_address" type="text"
                                            ...
                                            name="home_address" value="{{ $tutor->person->home_address ?? '' }}"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="dpi" type="text" class="form-control @error('dpi') is-invalid @enderror"
                                            name="dpi" value="{{ $tutor->dpi ?? '' }}" autocomplete="dpi" autofocus>
                                        @error('dpi')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="occupation" type="text"
                                            ...
                                            value="{{ $tutor->occupation ?? '' }}" autocomplete="occupation" autofocus>
                                        @error('occupation')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                                ...
                                                <tr id="1">
                                                    <td data-label="Estudiante" scope="row">
                                                        @foreach ($students->get() as $index => $student)
                                                            {{ old('student_id', $tstudent->student_id ?? '') == $index ? $student : '' }}
                                                        @endforeach
                                                    </td>
                                                    <td data-label="Acción" scope="row">
                                                        @if (isset($tstudent) && is_object($tstudent))
                                                            <a href="{{ action('TutorController@destroystudent', ['tutor_id' => $tstudent->tutor_id, 'student_id' => $tstudent->student_id]) }}"
                                ...
                                <div class="form-group row mb-0">
                                    <div class="col-md-6 offset-md-4">
                                        ...
                                        @if (isset($tutor) && is_object($tutor))
                                        <a href="{{ action('TutorController@destroy', ['id' => $tutor->id]) }}"
