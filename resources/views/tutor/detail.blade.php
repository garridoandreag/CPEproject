                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="first_surname" type="text"
                                            ...
                                            required autocomplete="first_surname" autofocus readonly>
                                        @error('first_surname')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="second_surname" type="text"
                                            ...
                                            autocomplete="second_surname" autofocus readonly>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="cellphone_number" type="text"
                                            ...
                                            autocomplete="cellphone_number" autofocus readonly>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="dpi" type="text" class="form-control @error('dpi') is-invalid @enderror"
                                            name="dpi" value="{{ $tutor->dpi ?? '' }}" autocomplete="dpi" autofocus readonly>
                                        @error('dpi')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="occupation" type="text"
                                            ...
                                            value="{{ $tutor->occupation ?? '' }}" autocomplete="occupation" autofocus readonly>
                                        @error('occupation')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
