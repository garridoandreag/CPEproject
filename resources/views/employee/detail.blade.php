            ...
            <div class="card-body">
              ...
              <form id="gradeForm" method="POST"
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-6">
                    <input id="names" type="text" class="form-control @error('names') is-invalid @enderror" name="names"
                      value="{{ $employee->person->names ?? '' }}" required autocomplete="names" autofocues readonly>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-6">
                    <input id="phone_number" type="tel" class="form-control @error('phone_number') is-invalid @enderror"
                      ...
                      autocomplete="phone_number" autofocues readonly>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-6">
                    <select disabled id="subdivision_code" name="subdivision_code"
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-6">
                    <input id="home_address" type="text" class="form-control @error('home_address') is-invalid @enderror"
                      ...
                      autocomplete="home_address" autofocues readonly>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-6">
                    <select disabled id="gender_id" name="gender_id"
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-6">
                    <select disabled id="job_id" name="job_id"
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-6">
                    <select disabled id="professor" name="professor"
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-6">
                    <input id="salary" type="text" class="form-control @error('salary') is-invalid @enderror"
                      name="salary" value="{{ $employee->salary ?? '' }}" autocomplete="salary" autofocues readonly>
                ...
                <div class="form-group row mb-0">
                  <div class="col-md-6 offset-md-4">
                    ...
                    <a href="{{ action('EmployeeController@edit', ['id' => $employee->id]) }}"
