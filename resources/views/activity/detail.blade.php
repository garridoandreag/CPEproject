                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form id="gradeForm" method="POST"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <textarea class="form-control" name="description"
                                            value="{{ $activity->description ?? '' }}" required readonly>{{ $activity->description ?? '' }}
                            </textarea>
                                ...
                                <div class="form-group row">
                                    <label for="type" class="col-md-4 col-form-label text-md-right">Tipo de
                                        actividad</label>
                                    <div class="col-md-6">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <select id="unit_id" name="unit_id"
                                            class="form-control  @error('unit_id') is-invalid @enderror" disabled>
                                ...
                                <div class="form-group row">
                                    <label for="delivery_date" class="col-md-4 col-form-label text-md-right">Fecha de
                                        Entrega</label>
                                    <div class="col-md-6">
                                        <input id="delivery_date" type="date"
                                            class="form-control @error('delivery_date') is-invalid @enderror"
                                            name="delivery_date" value="{{ $activity->delivery_date ?? '' }}" required
                                            autocomplete="delivery_date" autofocus readonly>
                      ...
                      btn btn-outline-secondary">Cancelar</a>
                                        <a href="{{ action('ActivityController@edit', ['id' => $activity->id]) }}"
