          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <form id="gradeForm" method="POST"
                action="{{ isset($activity) ? route('activity.update') : route('activity.store') }}"
                enctype="multipart/form-data" aria-label="actividades">
                {{ csrf_field() }}
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-6">
                    <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name"
                      value="{{ $activity->name ?? '' }}" required autocomplete="name" autofocus readonly>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-6">
                    <textarea class="form-control" name="description" value="{{ $activity->description ?? '' }}" required
                      readonly>{{ $activity->description ?? '' }}
                    </textarea>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-6">
                    <input id="score" type="number" step="any" min="0"
                      class="form-control @error('score') is-invalid @enderror" name="score"
                      value="{{ $activity->score ?? '' }}" required autocomplete="score" autofocus readonly>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-6">
                    <select id="type" name="type" class="form-control  @error('type') is-invalid @enderror" disabled>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-6">
                    <select id="coursegrade_id" name="coursegrade_id"
                      class="form-control  @error('coursegrade_id') is-invalid @enderror" disabled>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-6">
                    <input id="delivery_date" type="date"
                      ...
                      value="{{ $activity->delivery_date ?? '' }}" required autocomplete="delivery_date" autofocus
                      readonly>
                ...
                <div class="form-group row mb-0">
                  <div class="col-md-6 offset-md-4">
                    <a href="{{ route('courseprofessor.index') }}" class="btn btn-outline-secondary">Cancelar</a>
                      <a href="{{action('ActivityController@edit',['id' => $activity->id])}}" class="btn btn-primary">Editar</a>
