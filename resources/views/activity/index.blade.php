        ...
        <div class="card">
          ...
          <div class="card-body">
            ...
            <div class="row justify-content-md-center">
              <div class="col">
                <a href="{{ action('ActivityController@create') }}" class="btn btn-primary">Nuevo </a>
              </div>
              ...
              <tbody id="myTable">
                @foreach ($activities as $activity)
                  <tr>
                    ...
                    <td data-label="Actividad"><a href="{{ action('ActivityController@detail', ['id' => $activity->id]) }}" />
                      {{ $activity->name }}
                      </a>
                    </td>
                    <td data-label="Puntos"><a href="{{ action('ActivityController@detail', ['id' => $activity->id]) }}" />
                      {{ $activity->score }}
                      </a>
                    </td>
                    <td data-label="Fecha de Entrega"><a href="{{ action('ActivityController@detail', ['id' => $activity->id]) }}" />
