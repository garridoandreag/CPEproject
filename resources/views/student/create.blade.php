                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form id="studentForm" method="POST"
                                action="{{ isset($student) ? route('student.update') : route('student.store') }}"
                                ...
                                <ul class="nav nav-tabs" id="myTab" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link active" id="form_personal" data-toggle="tab" href="#personal"
                                            role="tab" aria-controls="personal" aria-selected="true">PERSONAL</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" id="form_personal" data-toggle="tab" href="#academico"
                                            role="tab" aria-controls="academico" aria-selected="false">ACADEMICO</a>
                                    </li>
                                </ul>
                                ...
                                <div class="tab-content" id="myTabContent" style="margin-top:16px;">
                                    <div class="tab-pane fade show active" id="personal" role="tabpanel"
                                        aria-labelledby="form_personal">

                                        <div class="form-group row">
                                            <label for="favorite_name" class="col-md-4 col-form-label text-md-right">COMO
                                                DESEA SER LLAMADO</label>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-6">
                                                <input id="names" type="text"
                                                    ...
                                                    value="{{ $student->person->names ?? '' }}" required
                                                    autocomplete="names" autofocus>
                                        ...
                                        <div class="form-group row">
                                            <label for="second_surname"
                                                class="col-md-4 col-form-label text-md-right">SEGUNDO APELLIDO</label>

                                            <div class="col-md-6">
                                                <input id="second_surname" type="text"
                                                    class="form-control @error('second_surname') is-invalid @enderror"
                                                    name="second_surname"
                                                    value="{{ $student->person->second_surname ?? '' }}" required
                                                    autocomplete="second_surname" autofocus>
                                        ...
                                        <div class="form-group row">
                                            <label for="gender_id"
                                                class="col-md-4 col-form-label text-md-right">GÉNERO</label>
                                        ...
                                        <div class="form-group row mb-0">
                                            <div class="col-md-6 offset-md-4">
                                                <a class="btn btn-outline-primary" id="profile-tab" data-toggle="tab"
                                                    href="#academico" role="tab" aria-controls="academico"
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-6">
                                                <input id="student_code" type="text"
                                                    ...
                                                    name="student_code" value="{{ $student->student_code ?? '' }}" required
                                        ...
                                        @if (isset($student) && is_object($student))
                                            @foreach ($student->caregiver as $caregiver)
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-6">
                                                                <input id="surname_caregiver" type="text"
                                                                    ...
                                                                    value="{{ $caregiver->surname ?? '' }}" required
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group row">
                                                            <label for="phone_number_caregiver"
                                                            ...
                                                            <div class="col-md-6">
                                                                <input id="phone_number_caregiver" type="text"
                                                                    ...
                                                                    value="{{ $caregiver->phone_number ?? '' }}" required
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-6">
                                                            <input id="name_caregiver" type="text"
                                                                ...
                                                                required autocomplete="name_caregiver" autofocus>
