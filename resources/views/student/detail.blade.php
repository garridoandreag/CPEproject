                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="favorite_name" type="text"
                                            ...
                                            required autocomplete="favorite_name" autofocus readonly>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="second_surname" type="text"
                                            ...
                                            required autocomplete="second_surname" autofocus readonly>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="phone_number" type="text"
                                            ...
                                            required autocomplete="phone_number" autofocus readonly>
                                        @error('phone_number')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="home_address" type="text"
                                            ...
                                            required autocomplete="home_address" autofocus readonly>
                                        @error('phone_number')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="student_code" type="text"
                                            ...
                                            autocomplete="student_code" autofocus readonly>
                                ...
                                <br>
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            <div class="col">
                                                ...
                                                <select name="dad_id" class="select-dad" id="select-dad" disabled>
                                    ...
                                    <div class="form-group col-md-6">
                                        <div class="col">
                                            ...
                                            <select name="mom_id" class="select-mom" id="select-mom" disabled>
