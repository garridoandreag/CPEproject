                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-6">
                    <input id="favorite_name" type="text"
                      ...
                      value="{{ $student->person->favorite_name ?? '' }}" required autocomplete="favorite_name" autofocus readonly>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-6">
                    <input id="names" type="text" class="form-control @error('names') is-invalid @enderror" name="names"
                      value="{{ $student->person->names ?? '' }}" required autocomplete="names" autofocus readonly>
                    @error('names')
                    <span class="invalid-feedback" role="alert">
                      <strong>{{ $message }}</strong>
                    </span>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-6">
                    <input id="first_surname" type="text"
                      ...
                      value="{{ $student->person->first_surname ?? '' }}" required autocomplete="first_surname" autofocus readonly>
                    @error('first_surname')
                    <span class="invalid-feedback" role="alert">
                      <strong>{{ $message }}</strong>
                    </span>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-6">
                    <input id="phone_number" type="text" class="form-control @error('phone_number') is-invalid @enderror"
                      name="phone_number" value="{{ $student->person->phone_number ?? '' }}" required
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-6">
                    <input id="home_address" type="text" class="form-control @error('home_address') is-invalid @enderror"
                      name="home_address" value="{{ $student->person->home_address ?? '' }}" required
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-6">
                    <input id="birthday" type="date" class="form-control @error('birthday') is-invalid @enderror"
                      name="birthday" value="{{ $student->birthday ?? '' }}" required autocomplete="birthday" autofocus readonly>
                    ...
                    @else
                      <tr id="1">
                        ...
                        <td data-label="Parentesco" scope="row">
                          <input id="relationship" type="text"
                            class="form-control form-control-sm @error('relationship') is-invalid @enderror"
                            name="relationship[]" value="{{ $caregiver->relationship ?? '' }}" autocomplete="relationship"
                            autofocus readonly>
                        </td>
                        <td data-label="Teléfono" scope="row">
                          <input id="phone_number_caregiver" type="text"
